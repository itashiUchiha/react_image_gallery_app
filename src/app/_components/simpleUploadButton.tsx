...
export function SimpleUploadButton(){
    ...
    return(
        <div>
            <label htmlFor="upload-button"><UploadButtonSVG/></label>
            <input 
            id="upload-button" 
            type="file" 
            className="sr-only" 
